...
Pc1=PointCloud;
Pc2=PointCloud;
Pc1=ImportPointCloudFromASCII('Blocs_EGU_avant.txt','Pc1',{'P','Intensities'});
Pc2=ImportPointCloudFromASCII('Blocs_EGU_apres.txt','Pc2',{'P','Intensities'});
Pc1.TLSPos=[547325;149383;614];
Pc2.TLSPos=[547325;149383;614];

[PCRockfall,T1] = RockfallExtract(Pc1,Pc2,[],[],'P2P',0); %%#ok<MSNU>
figure;
[Rockfalls_events,Eps] = RockfallSegment(PCRockfall,20,[],0); %#o%#ok<MSNU> k<NASGU>
figure;

for R=0.01:0.05:1
[BlocksVolume, SS] = RockfallVolume(Rockfalls_events,R,0);
hold on;
loglog(sort(BlocksVolume,'descend'))
end
